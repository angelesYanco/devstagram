                ...
                @auth
                    <nav class="flex gap-2 items-center">
                        <a 
                            ...
                            {{-- class="flex items-center gap-2 bg-white border p-2 text-gray-600 rouded text-sm  font-bold cursor-pointer" --}}
                            class="flex items-center gap-2 bg-white p-2 text-gray-600 rouded text-sm  font-bold cursor-pointer"
                        >
                            Crear:
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button type="submit" class="font-bold text-gray-600 text-sm">
                                Cerrar:<span class="font-normal"> Sesion</span> 
                            </button>
                        </form>
                    </nav>
                @endauth
